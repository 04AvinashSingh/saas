...
const WriteArticle = () => {
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start items-start flex-wrap gap-4 text-slate-700'>
      {/* left col*/}
      ...
      border-gray-200'>
        ...
        <br />
        <button diaabled={loading} className='w-full flex justify-center items-center gap-2 
        bg-gradient-to-r from-[#226BFF] to-[#65ADFF] text-white px-4 py-2 mt-6
        text-sm rounded-lg cursor-pointer'>
          {
            loading?<span className="w-4 h-4 my-1 rounded-full border-2 vorder-t-transparent animate-spin"></span>
            :<Edit className='w-5'/>
          }
      ...
      border-gray-200 min-h-96 max-h-96 max-h-[600px]'>
        ...
        {!content?(
          ...
          <div className='text-sm flex flex-col item-center gap-5 text-gray-400'>
