...
const AiTools = () => {
    ...
    const {user}=useUser()
  return (
    <div className='px-2 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            <h2 className='text-slate-700 text-[42px] font-semibold'>Powerful AI Tools</h2>
            <p className='text-gray-500 max-w-lg mx-auto'>Everthing you need to create, enhance, and optimize your content with cutting-edge
                AI technology
            </p>
        </div>
