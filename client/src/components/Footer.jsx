...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-16 border-b border-gray-500/30 pb-10">
        <div className="md:max-w-96">
            <img className="h-9" src={assets.logo} alt="dummyLogoDark"/>
            <p className="mt-6 text-sm">
                Experiance the power of AI with QuickAi. <br />Transform your 
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © AIsaas. All Right Reserved.
    </p>
</footer>
  )
}
